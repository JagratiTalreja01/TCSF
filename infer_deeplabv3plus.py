"""Save U-Net predictions for later multi-model paper panels."""
...
def parse_args():
    ...
    parser.add_argument("--config", default="configs/deeplabv3plus_base.yaml")
    parser.add_argument("--checkpoint", required=True)
    parser.add_argument(
        "--save_dir",
        default="outputs/predictions/DeepLabV3Plus_200ep_seed2026",
    )
...
def save_preview(rgb, target, probability, prediction, path, sample_id, metrics):
    ...
    panels = [
        ...
        (prediction, "U-Net Prediction", "gray"),
...
def main():
    ...
    for batch in tqdm(loader, desc="Saving DeepLabV3+ predictions"):
    ...
    print("\n" + "=" * 68)
    print("DEEPLABV3+ PREDICTION EXPORT COMPLETED")
    print("=" * 68)
