"""Save SegFormer predictions for later multi-model paper panels."""
...
def parse_args():
    ...
    parser.add_argument("--config", default="configs/segformer_base.yaml")
    parser.add_argument("--checkpoint", required=True)
    parser.add_argument(
        "--save_dir",
        default="outputs/predictions/SegFormer_B0_200ep_seed2026",
    )
...
def save_preview(rgb, target, probability, prediction, path, sample_id, metrics):
    ...
    panels = [
        ...
        (prediction, "SegFormer Prediction", "gray"),
...
def main():
    ...
    for batch in tqdm(loader, desc="Saving SegFormer predictions"):
    ...
    print("\n" + "=" * 68)
    print("SegFormer PREDICTION EXPORT COMPLETED")
    print("=" * 68)
