...
def parse_args():
    ...
    parser.add_argument("--config", default="configs/unet_base.yaml")
    parser.add_argument("--checkpoint", required=True)
    parser.add_argument(
        "--save_dir",
        default="outputs/predictions/UNet_200ep_seed2026",
    )
...
def main():
    ...
    for batch in tqdm(loader, desc="Saving U-Net predictions"):
    ...
    print("\n" + "=" * 68)
    print("U-NET PREDICTION EXPORT COMPLETED")
    print("=" * 68)
