...
Test-set evaluation for the multimodal early-fusion DeepLabV3+ baseline.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate the multimodal DeepLabV3+ baseline."
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="outputs/test/DeepLabV3Plus_200ep_seed2026",
    )
    parser.add_argument(
        "--threshold",
        type=float,
