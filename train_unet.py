...
Training script for the multimodal early-fusion U-Net baseline.
...
Expected model file:
    models/baselines/unet_baseline.py

Expected config:
    configs/unet_base.yaml
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the multimodal U-Net baseline."
    )
...
def main() -> None:
    ...
    default_output_dir = cfg.get("output", {}).get(
        "checkpoint_dir",
        "outputs/checkpoints/UNet_seed2026",
    )
