...
Test-set evaluation for the multimodal early-fusion Swin-UNet baseline.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate the multimodal Swin-UNet baseline."
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="outputs/test/Swin-UNet_B0_200ep_seed2026",
    )
    parser.add_argument(
        "--threshold",
        type=float,
