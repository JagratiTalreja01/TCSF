...
Test-set evaluation for the multimodal early-fusion Vision Mamba baseline.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate the multimodal Vision Mamba baseline."
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="outputs/test/VisionMamba_200ep_seed2026",
    )
    parser.add_argument(
        "--threshold",
        type=float,
...
def main() -> None:
    ...
    print("\n" + "=" * 62)
    print("VISION MAMBA TEST RESULTS")
    print("=" * 62)
